...
def opc_zipread_test(path):
    test.call(
        test.build("opc_zipread"),
        [],
        ["--verify", test.docs(path)],
        test.tmp(path + ".opc_zipread"),
        [],
        {},
    )
...
def opc_extract_test(path, part):
    ...
    test.call(
        test.build("opc_extract"),
        [],
        [test.docs(path), part],
        test.tmp(path) + out_ext,
        [],
        {},
    )
...
def opc_relation_test(path):
    test.call(
        test.build("opc_relation"),
        [],
        [test.docs(path)],
        test.tmp(path + ".opc_relation"),
        [],
        {},
    )
    ...
    test.call(
        ...
        [],
        [test.docs(path), "rId1"],
        test.tmp(path + ".opc_relation.rId1"),
        [],
        {},
    )
    test.regr(
        test.docs(path + ".opc_relation.rId1"),
        test.tmp(path + ".opc_relation.rId1"),
        True,
    )
    test.call(
        test.build("opc_relation"),
        [],
        [test.docs(path), "word/document.xml", "rId1"],
        test.tmp(path + ".opc_relation.word-document.rId1"),
        [],
        {},
    )
    test.regr(
        test.docs(path + ".opc_relation.word-document.rId1"),
        test.tmp(path + ".opc_relation.word-document.rId1"),
        True,
    )
...
def opc_image_test(path):
    test.call(
        test.build("opc_image"),
        [],
        [test.docs(path), test.tmp("")],
        test.tmp(path + ".opc_image"),
        [],
        {},
    )
...
def opc_text_test(path):
    test.call(
        ...
        [],
        [test.docs(path)],
        test.tmp(path + ".opc_text.html"),
        [],
        {},
    )
    test.regr(
        test.docs(path + ".opc_text.html"), test.tmp(path + ".opc_text.html"), True
    )
...
def opc_part_test(path):
    test.call(
        test.build("opc_part"),
        [],
        [test.docs(path), "word/document.xml"],
        test.tmp(path + ".opc_part"),
        [],
        {},
    )
...
def opc_zipextract_test(path):
    test.call(
        test.build("opc_zipextract"),
        [],
        [test.docs(path), "word/document.xml"],
        test.tmp(path + ".opc_zipextract"),
        [],
        {},
    )
    test.regr(
        test.docs(path + ".opc_zipextract"), test.tmp(path + ".opc_zipextract"), True
    )
...
def opc_zipwrite_test(path):
    ...
    test.call(
        test.build("opc_zipwrite"),
        [],
        [test.tmp(path), "--import", "--delete", "--add", "--commit"],
        test.tmp("stdout.txt"),
        [],
        {},
    )
    test.call(
        test.build("opc_zipread"),
        [],
        ["--verify", test.tmp(path)],
        test.tmp(path + "_1.opc_zipread"),
        [],
        {},
    )
    test.regr(
        test.docs(path + "_1.opc_zipread"), test.tmp(path + "_1.opc_zipread"), True
    )

    test.call(
        test.build("opc_zipwrite"),
        [],
        [test.tmp(path), "--import", "--commit"],
        test.tmp("stdout.txt"),
        [],
        {},
    )
    test.call(
        ...
        [],
        ["--verify", test.tmp(path)],
        test.tmp(path + "_2.opc_zipread"),
        [],
        {},
    )
    test.regr(
        test.tmp(path + "_1.opc_zipread"), test.tmp(path + "_2.opc_zipread"), True
    )

    test.call(
        test.build("opc_zipwrite"),
        [],
        [test.tmp(path), "--import", "--trim"],
        test.tmp("stdout.txt"),
        [],
        {},
    )
    test.call(
        ...
        [],
        ["--verify", test.tmp(path)],
        test.tmp(path + "_3.opc_zipread"),
        [],
        {},
    )
    test.regr(
        test.docs(path + "_3.opc_zipread"), test.tmp(path + "_3.opc_zipread"), True
    )

    test.call(
        test.build("opc_zipwrite"),
        [],
        [test.tmp(path), "--delete", "--commit"],
        test.tmp("stdout.txt"),
        [],
        {},
    )
    test.call(
        ...
        [],
        ["--verify", test.tmp(path)],
        test.tmp(path + "_4.opc_zipread"),
        [],
        {},
    )
    test.regr(
        test.docs(path + "_4.opc_zipread"), test.tmp(path + "_4.opc_zipread"), True
    )

    test.call(
        test.build("opc_zipwrite"),
        [],
        [test.tmp(path), "--delete", "--trim"],
        test.tmp("stdout.txt"),
        [],
        {},
    )
    test.call(
        ...
        [],
        ["--verify", test.tmp(path)],
        test.tmp(path + "_5.opc_zipread"),
        [],
        {},
    )
    test.regr(
        test.docs(path + "_5.opc_zipread"), test.tmp(path + "_5.opc_zipread"), True
    )
...
def opc_trim_test(path):
    ...
    test.call(
        ...
        [],
        [test.docs(path)],
        test.tmp(path + "_1.opc_trim.opc_dump"),
        [],
        {},
    )
    test.regr(
        test.docs(path + ".opc_dump"), test.tmp(path + "_1.opc_trim.opc_dump"), True
    )
    test.call(
        test.build("opc_trim"), [], [test.tmp(path)], test.tmp("stdout.txt"), [], {}
    )
    test.call(
        test.build("opc_dump"),
        [],
        [test.docs(path)],
        test.tmp(path + "_2.opc_trim.opc_dump"),
        [],
        {},
    )
    test.regr(
    ...
    test.call(
        ...
        [],
        [test.docs(path)],
        test.tmp(path + "_3.opc_trim.opc_dump"),
        [],
        {},
    )
    test.regr(
    ...
    test.call(
        ...
        [],
        [test.docs(path)],
        test.tmp(path + "_4.opc_trim.opc_dump"),
        [],
        {},
    )
    test.regr(
...
def mce_extract_test(path, part, namespaces, returncode):
    ...
    for namespace in namespaces:
        args.append("--understands")
        args.append(namespace[1])
        _part_ = _part_ + "." + namespace[0]
    test.call(
        test.build("mce_extract"),
        [],
        args,
        test.tmp(path + _part_ + ".mce_extract"),
        [],
        {"return": returncode},
    )
    test.regr(
        test.docs(path + _part_ + ".mce_extract"),
        test.tmp(path + _part_ + ".mce_extract"),
        True,
    )
...
def mce_write_test(path):
    test.rm(test.tmp(path))
    test.call(
        test.build("mce_write"), [], [test.tmp(path)], test.tmp("stdout.txt"), [], {}
    )
    test.call(
        test.build("mce_extract"),
        [],
        [test.tmp(path), "sample.xml"],
        test.tmp(path + ".mce_write.mce_extract"),
        [],
        {},
    )
    test.regr(
        test.docs(path + ".mce_write.mce_extract"),
        test.tmp(path + ".mce_write.mce_extract"),
        False,
    )
    test.call(
        ...
        [
            test.tmp(path),
            "--understands",
            "http://schemas.openxmlformats.org/Circles/v2",
            "sample.xml",
        ],
        test.tmp(path + ".mce_write.v2.mce_extract"),
        [],
        {},
    )
    test.regr(
        test.docs(path + ".mce_write.v2.mce_extract"),
        test.tmp(path + ".mce_write.v2.mce_extract"),
        False,
    )
...
def mcepp_test(path):
    test.rm(test.tmp(path))
    test.call(
        test.build("mcepp"), [], [test.docs(path)], test.tmp(path + ".mcepp"), [], {}
    )
...
def opc_generate_test(basepath, path):
    dest = os.path.join(
        os.path.split(path)[0], os.path.splitext(os.path.split(path)[1])[0] + ".c"
    )
    ...
    test.call(
        ...
        test.tmp(path + "_1.opc_generate.opc_dump"),
        [],
        {},
    )
    test.call(
        test.build("opc_generate"),
        [],
        [os.path.join(basepath, path), test.tmp(dest)],
        test.tmp("stdout.txt"),
        [],
        {},
    )
    ...
    test.call(
        ...
        [],
        [test.tmp(path)],
        test.tmp(path + "_2.opc_generate.opc_dump"),
        [],
        {},
    )
    test.regr(
...
if __name__ == "__main__":
    ...
    try:
        opts, args = getopt.getopt(
            sys.argv[1:], "h", ["help", "target=", "generate=", "skip", "type="]
        )
    ...
    if None == generate_path:
        ...
        opc_zipread_test(
            "stream.zip"
        )  # fails --- streaming mode is not yet implemented.
        ...
        mce_extract_test(
            "mce.zip",
            "circles-ignorable.xml",
            [["v2", "http://schemas.openxmlformats.org/Circles/v2"]],
            0,
        )
        mce_extract_test(
            "mce.zip",
            ...
            [
                ["v2", "http://schemas.openxmlformats.org/Circles/v2"],
                ["v3", "http://schemas.openxmlformats.org/Circles/v3"],
            ],
            0,
        )
        ...
        mce_extract_test(
            "mce.zip",
            "circles-ignorable-ns.xml",
            [["v1", "http://schemas.openxmlformats.org/MyExtension/v1"]],
            0,
        )
        ...
        mce_extract_test(
            "mce.zip",
            "circles-alternatecontent2.xml",
            [["v1", "http://schemas.openxmlformats.org/metallicfinishes/v1"]],
            0,
        )
        ...
        mce_extract_test(
            "mce.zip",
            "circles-processcontent-ns.xml",
            [["ext", "http://schemas.openxmlformats.org/Circles/extension"]],
            0,
        )
        ...
        opc_proc_test(
            "OOXMLI1.docx", ["--delete", "customXml/item1.xml", "--dump"], "delete"
        )
        opc_proc_test(
            "OOXMLI1.docx",
            [
